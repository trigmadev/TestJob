...
{
	public class JornaleroEditText : EditText
	{
		protected JornaleroEditText (IntPtr javaReference, JniHandleOwnership transfer)
			: base (javaReference, transfer)
		{
		}

		public JornaleroEditText (Context context)
			: this (context, null)
		{
		}

		public JornaleroEditText (Context context, IAttributeSet attrs)
			: this (context, attrs, 0)
		{
		}

		public JornaleroEditText (Context context, IAttributeSet attrs, int defStyle)
